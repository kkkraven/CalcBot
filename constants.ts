...
// Оптимизированные промпты для снижения токенов
export const KNOWLEDGE_BASE_STRUCTURE_PROMPT_COMPACT = `
База знаний: таблица с колонками ID, ProductType, Quantity, PricePerUnit_CNY, Width_mm, Height_mm, Depth_mm, Material, MaterialDensity_gsm, PrintColors_Outer, PrintType, Finish1, HandlesType, HandleAttachment, Fittings, Notes.

Примеры: Пакет 1000шт 2.5¥ 300x400x100мм мелованная 230г 4+0CMYK офсет матовая репс вклеенные; Коробка 500шт 5.0¥ 200x150x50мм гофрокартон 1+0Pantone флексография.
`;

export const PRICING_RULES_PROMPT_COMPACT = `
Правила: 1) Цена снижается с тиражом (1000шт на 20-40% дешевле 500шт); 2) Спецматериалы дороже; 3) Сложная печать дороже; 4) Отделка добавляет стоимость; 5) Большие размеры дороже.

Ориентиры: Пакеты мелованные 200-250г: малые 1000шт ~3¥, 500шт ~4¥; средние 1000шт ~3.5¥, 500шт ~4.8¥; крупные 1000шт ~4.2¥, 500шт ~5.5¥. Крафт на 25-40% дешевле. Тиснение +0.6-1.8¥, люверсы +0.3-0.6¥.

Коробки: малые 1000шт 4-7¥, средние 500шт 18-25¥, крупные 1000шт 30-38¥. Бирки 6000шт 0.4-0.8¥.
`;